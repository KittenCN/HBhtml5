...
<div id="app-main">
    <table style="display: inline-table;" width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td colspan="2">
                <a href="pay.aspx">
                    <img src="img/money_08_grey.jpg" width="100%" alt="">
                </a>
            </td>
            <td colspan="2">
                ...
                <div class="am-form">
                  <fieldset>
                    ...
                    <div class="am-form-group">
                      <label for="textfield">请输入储值金额</label>
                      <input type="text" class="" id="textfield" placeholder="">
                    </div>
                    <div class="am-form-group">
                      <label for="radio">请选择支付方式</label>
                      <input type="radio" name="radio" id="radio" value="radio"> 银联支付
                    </div>
