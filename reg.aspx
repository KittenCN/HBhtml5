...
<body>
 ...
 <div class="container">
  ...
  <form id="form_reg" runat="server"> 
    <table width="100%" border="0" background="image/reg-m.jpg">
      <tr>
        <td width="31%">&nbsp;</td>
        <td width="14%">&nbsp;</td>
        <td colspan="2">&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2"><label for="textfield"></label></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="2">
            ...
            <asp:TextBox ID="tb_phonenum" runat="server"></asp:TextBox>
          </td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="2">
            ...
            <asp:TextBox ID="tb_pass1" runat="server" TextMode="Password"></asp:TextBox>
          </td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="18">&nbsp;</td>
        <td align="center">&nbsp;</td>
        <td colspan="2" align="left"><label for="textfield3"></label></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="18">&nbsp;</td>
      ...
      <tr>
        ...
        <td class="auto-style1">
            <asp:TextBox ID="tb_checkvalue" runat="server" Width="111px"></asp:TextBox>
          </td>
        <td>
            <asp:Button ID="btn_checkvalue" runat="server" OnClick="btn_checkvalue_Click" Text="发送验证码" />
          </td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        ...
        <td colspan="3" rowspan="3" align="center">
            <input type="image" name="imageField" id="imageField" src="image/reg.jpg" runat="server" onserverclick="Reg" />
        </td>
        <td>&nbsp;</td>
      </tr>
      <tr>
