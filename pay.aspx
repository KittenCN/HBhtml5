  ...
  <form action="welcome.html">
    <table width="1300" border="0" background="image/member.jpg">
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="5" rowspan="5"><img src="image/top4.jpg" width="578" height="101" usemap="#Map"></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td align="right">&nbsp;</td>
        <td align="right">&nbsp;</td>
        <td align="right">13916697479 <a href="login.html">【退出】</a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2"><strong>会员卡储值</strong></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td height="18">&nbsp;</td>
        <td>&nbsp;</td>
        <td align="left">请输入储值金额：</td>
        <td colspan="2" align="left"><input type="text" name="textfield" id="textfield"></td>
        <td align="left">&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="23">&nbsp;</td>
        <td>&nbsp;</td>
        <td align="left">请选择支付方式：</td>
        <td colspan="2" align="left"><input type="radio" name="radio" id="radio" value="radio">
          银联支付</td>
        <td align="left">&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td width="176" rowspan="2" align="left"><input type="image" name="imageField" id="imageField" src="image/btn_wx.jpg"></td>
        <td align="left">&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td>&nbsp;</td>
